    ...
    return (
      <div>
        ...
        <Row className="show-grid">
          <div className="social-media">
            <Col lgOffset={2} lg={4} xs={12}>
              <Button className="center-block btn-fb" bsStyle="primary" bsSize="large"
                      onClick={this.loginWithFacebookHandler}>Logowanie z <span
                className="text-bold"> Facebook</span></Button>
            </Col>
            <Col lg={4} xs={12}>
              <Button className="center-block btn-google" bsStyle="primary" bsSize="large"
                      onClick={this.loginWithGoogleHandler}>Logowanie z <span
        ...
        <div className="login-panel center-block">
          ...
          <p><Glyphicon glyph="floppy-saved"/> Zapomniałeś hasła? Nic straconego ! <a className="cursor"
                                                                                      onClick={() => {
                                                                                        this.modalOpen(3)
                                                                                      }}>Możesz je odzyskać.</a></p>
